    ...
    <div class="col-sm-6">
        ...
        <div class="dslc-blog-post-meta">
            <div class="dslc-blog-post-meta-author ">
                ...
                </span>By <a href="mailto: <?= get_the_author_meta('user_email'); ?>" title="Posts by nitin@blueastral.com" rel="author" class="anchor_tag"><?= get_the_author_meta('user_email'); ?></a>
            </div>
            <div class="dslc-blog-post-meta-date date"><?= get_the_date(); ?></div>
            <div class="clearfix"></div>
        </div>
        <div class="description"><?php echo wp_trim_words(get_the_content(), 45, '...'); ?></div>
        <div class="read-more">
