 ...
 */
class seowp_testimonials_lg_slider extends Widget_Base {
	/**
	 * Define our get_name settings.
	 */
	public function get_name() {
		return 'testimonials_lg';
	}
	/**
	 * Define our get_title settings.
	 */
	public function get_title() {
		return 'Testimonials Full Width Slider';
	}
	/**
	...
	public function render() {
        ...
        echo do_shortcode('[testimonials_lg_slider show_filters="false"]');
 }
	
}
/*=============Call this every widget ====================*/
Plugin::instance()->widgets_manager->register_widget_type( new seowp_testimonials_lg_slider() );
