 ...
 */
class flat_customblog_hcard_class extends Widget_Base {
	/**
	 * Define our get_name settings.
	 */
	public function get_name() {
		return 'flat_customblog_hcard';
	}
	/**
	 * Define our get_title settings.
	 */
	public function get_title() {
		return 'flat custom blog hcard';
	}
	/**
	...
	public function render() {
        ...
        echo do_shortcode('[flat_customblog_hcard show_filters="false"]');
 }
	
}
/*=============Call this every widget ====================*/
Plugin::instance()->widgets_manager->register_widget_type( new flat_customblog_hcard_class() );
