 ...
 */
class flat_blog_blocks extends Widget_Base {
	/**
	 * Define our get_name settings.
	 */
	public function get_name() {
		return 'flat_blog_blocks';
	}
	/**
	 * Define our get_title settings.
	 */
	public function get_title() {
		return 'Flat blog blocks';
	}
	/**
	...
	public function render() {
        ...
        echo do_shortcode('[flat_blog_blocks show_filters="false"]');
 }
	
}
/*=============Call this every widget ====================*/
Plugin::instance()->widgets_manager->register_widget_type( new flat_blog_blocks() );
