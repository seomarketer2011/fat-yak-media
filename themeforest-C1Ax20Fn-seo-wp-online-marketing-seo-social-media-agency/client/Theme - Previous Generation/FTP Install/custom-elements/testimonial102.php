 ...
 */
class seowp_testimonial_102 extends Widget_Base {
	/**
	 * Define our get_name settings.
	 */
	public function get_name() {
		return 'testimonial102';
	}
	/**
	 * Define our get_title settings.
	 */
	public function get_title() {
		return 'Testimonial Founder & CEO';
	}
	/**
	...
	public function render() {
        ...
        echo do_shortcode('[testimonial_102 show_filters="false"]');
 }
	
}
/*=============Call this every widget ====================*/
Plugin::instance()->widgets_manager->register_widget_type( new seowp_testimonial_102() );
