 ...
 */
class flat_descriptive_blog extends Widget_Base {
	/**
	 * Define our get_name settings.
	 */
	public function get_name() {
		return 'flat_descriptive_blog';
	}
	/**
	 * Define our get_title settings.
	 */
	public function get_title() {
		return 'Flat descriptive blog';
	}
	/**
	...
	public function render() {
        ...
        echo do_shortcode('[flat_descriptive_blog show_filters="false"]');
 }
	
}
/*=============Call this every widget ====================*/
Plugin::instance()->widgets_manager->register_widget_type( new flat_descriptive_blog() );
