        ...
        function ajax_callback(response) {
            ...
            if(typeof response == "object" && typeof response.message !== "undefined"){
                ...
                if( typeof response.num_of_imported_posts !== "undefined" && 0 < total_content_import_items ) {
                    ...
                    // Fix the bug with wrong current import itmes count due to repetitive Ajax.
                    if ( current_content_import_items > total_content_import_items ) {
                        current_content_import_items = total_content_import_items / 2;
                    }
                    update_progress_bar();
                }
