 ...
 */
class project_102_class extends Widget_Base {
	/**
	 * Define our get_name settings.
	 */
	public function get_name() {
		return 'Ctea-project-102';
	}
	/**
	 * Define our get_title settings.
	 */
	public function get_title() {
		return 'Custom blog vcard';
	}
	/**
	...
	public function render() {
        ...
        echo do_shortcode('[project_102 show_filters="false"]');
 }
	
}
/*=============Call this every widget ====================*/
Plugin::instance()->widgets_manager->register_widget_type( new project_102_class() );
