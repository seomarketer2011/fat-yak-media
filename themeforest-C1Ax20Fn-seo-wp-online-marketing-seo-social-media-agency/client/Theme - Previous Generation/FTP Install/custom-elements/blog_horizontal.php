 ...
 */
class blog_horizontal extends Widget_Base {
	/**
	 * Define our get_name settings.
	 */
	public function get_name() {
		return 'Custom Blog horizontal';
	}
	/**
	...
	public function render() {
        ...
        echo do_shortcode('[blog_horizontal show_filters="false"]');
 }
	
}
/*=============Call this every widget ====================*/
Plugin::instance()->widgets_manager->register_widget_type( new blog_horizontal() );
