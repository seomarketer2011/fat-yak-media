...
$wizard = new Merlin(
	...
	$config = array(
		'directory'            => 'inc/installer', // Location / directory where Merlin WP is placed in your theme.
		'merlin_url'           => 'configurator', // The wp-admin page slug where Merlin WP loads.
	...
	$strings = array(
		'admin-menu'               => esc_html__( 'Theme Config', 'seowp' ),
		...
		'welcome%s'                => esc_html__( 'We need to install premium plugins and configure the theme for you.', 'seowp' ),
		...
		'plugins'                  => esc_html__( 'Our theme includes a few premium WordPress plugins. This step is required.', 'seowp' ),
		...
		'import'                   => esc_html__( 'Let\'s import ready to use content and premium illustrations.', 'seowp' ),
		'import-action-link'       => esc_html__( 'Advanced', 'seowp' ),

		'ready-header'             => esc_html__( 'All done. Have fun!', 'seowp' ),

		/* translators: Theme Author */
		'ready%s'                  => esc_html__( 'Your theme has been all set up.', 'seowp' ),
		'ready-action-link'        => esc_html__( 'Extras', 'seowp' ),
		'ready-big-button'         => esc_html__( 'View your website', 'seowp' ),
		'ready-link-1'             => sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://support.seowptheme.com/hc/3550656485', esc_html__( 'Theme Documentation', 'seowp' ) ),
		'ready-link-2'             => sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://themeforest.net/item/seo-wp-online-marketing-seo-social-media-agency/8012838/support', esc_html__( 'Get Theme Support', 'seowp' ) ),
