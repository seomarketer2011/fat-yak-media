 ...
 */
class seowp_testimonial extends Widget_Base {
	/**
	...
	public function render() {
        ...
        echo do_shortcode('[testimonial show_filters="false"]');
 }
	
}
/*=============Call this every widget ====================*/
Plugin::instance()->widgets_manager->register_widget_type( new seowp_testimonial() );
