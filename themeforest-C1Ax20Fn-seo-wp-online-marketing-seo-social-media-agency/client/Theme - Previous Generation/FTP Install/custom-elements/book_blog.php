 ...
 */
class book_blog_class extends Widget_Base {
	/**
	 * Define our get_name settings.
	 */
	public function get_name() {
		return 'Ctea-book-blog';
	}
	/**
	...
	public function render() {
        ...
        echo do_shortcode('[book_blog show_filters="false"]');
 }
	
}
/*=============Call this every widget ====================*/
Plugin::instance()->widgets_manager->register_widget_type( new book_blog_class() );
