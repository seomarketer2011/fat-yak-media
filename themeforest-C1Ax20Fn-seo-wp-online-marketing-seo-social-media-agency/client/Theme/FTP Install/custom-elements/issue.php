 ...
 */
class seowp_issue extends Widget_Base {
	/**
	...
	public function render() {
        ...
        echo do_shortcode('[issue_sohrt show_filters="false"]');
 }
	
}
/*=============Call this every widget ====================*/
Plugin::instance()->widgets_manager->register_widget_type( new seowp_issue() );
