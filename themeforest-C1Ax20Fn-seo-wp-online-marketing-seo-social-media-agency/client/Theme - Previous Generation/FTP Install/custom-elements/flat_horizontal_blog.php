 ...
 */
class flat_horizontal_blog extends Widget_Base {
	/**
	 * Define our get_name settings.
	 */
	public function get_name() {
		return 'flat_horizontal_blog';
	}
	/**
	 * Define our get_title settings.
	 */
	public function get_title() {
		return 'Flat Horizontal Blog';
	}
	/**
	...
	public function render() {
        ...
        echo do_shortcode('[flat_horizontal_blog show_filters="false"]');
 }
	
}
/*=============Call this every widget ====================*/
Plugin::instance()->widgets_manager->register_widget_type( new flat_horizontal_blog() );
